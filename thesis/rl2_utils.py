...
class Logger:
    def __init__(self , num_epsiodes_of_validation=2, is_metaworld=False):
        '''
    ...
    def log_per_update_metrics(self , num_inner_loops_per_update):
        ...
        for env_name in self.per_env_total_return:
            ...
            if self.is_metaworld:
                ...
                wandb.log({env_name+' returns': env_return}, commit=False)
        ...
        if self.is_metaworld:
            ...
            wandb.log({
                'last episode return': last_episode_return,
